...
<head>
  ...
  <title>Registerasi | Aplikasi Desaku</title>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center mb-4">
                    <h1 class="h4 text-gray-900 font-weight-bold">Registerasi</h1>
                    <p class="small text-muted">Silakan daftar untuk melanjutkan</p>
                  </div>
                  <form method="POST" action="/register" class="user">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="name" class="form-control form-control-user" id="inputName" placeholder="Nama Lengkap" required>
                      </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary btn-user btn-block font-weight-bold">
                      <i class="fas fa-sign-in-alt mr-2"></i> Simpan
                    </button>
                  </form>
                  <hr>
                  <div class="text-center">
                    <a class="small" href="/">Login</a> | <a class="small" href="/">Forgot Password?</a>
