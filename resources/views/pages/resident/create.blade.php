...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <div class="form-group mb-3">
           ...
           <input type="text" inputmode="numeric" id="name" name="name"  placeholder="Masukkan Nama Lengkap" required
        ...
        <div class="form-group mb-3">
         ...
         <input type="text"  id="birth_place" name="birth_place" required placeholder="Masukkan Tempat Lahir" required
        ...
        <div class="form-group mb-3">
            ...
            <textarea  id="address" name="address" rows="3" required placeholder="Masukkan Alamat"
            class="form-control @error('address') is-invalid @enderror" value="{{ old('address') }}"></textarea>
        </div>
        <div class="form-group mb-3">
            <label for="religion">Agama</label>
            <input type="text" id="religion" name="religion" required placeholder="Masukkan Agama" required
            class="form-control @error('religion') is-invalid @enderror" value="{{ old('religion') }}">
        </div>
         <div class="form-group mb-3">
            <label for="marital_status">Status Perkawinan</label>
              <select  id="marital_status" name="marital_status" required
               class="form-control @error('maritial_status') is-invalid @enderror" value="{{ old('maritial_status') }}">
        ...
        <div class="form-group mb-3">
            ...
            <input type="text"  id="occupation" name="occupation" required placeholder="Masukkan Pekerjaan" required
             class="form-control @error('occupation') is-invalid @enderror" value="{{ old('occupation') }}">
        </div>
        <div class="form-group mb-3">
            <label for="phone">Telepon</label>
            <input type="text" inputmode="numeric" id="phone" name="phone" required placeholder="Masukkan Nomor Telepon" required
